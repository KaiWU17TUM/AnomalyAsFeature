...
class CNN_CLF(LightningModule):
    ...
    def train_dataloader(self):
        ...
        loader_train = DataLoader(ds_train, batch_size=self.config['batch_size'], num_workers=64)
        return loader_train

    def test_dataloader(self):
        data_test = self.data['test']
        ds_test = self.dataset(data_test)
        loader_test = DataLoader(ds_test, batch_size=self.config['batch_size'], num_workers=64)
        return loader_test

    def val_dataloader(self):
        data_val = self.data['val']
        ds_val = self.dataset(data_val)
        loader_val = DataLoader(ds_val, batch_size=self.config['batch_size'], num_workers=64)
        return loader_val
...
if __name__ == '__main__':
    ...
    data_file_raw = '/home/kai/workspace/data/mimic/training_data_raw_0imp.pkl'
    data_file_encoded = '/home/kai/workspace/data/mimic/training_data_encoded_0imp.pkl'
